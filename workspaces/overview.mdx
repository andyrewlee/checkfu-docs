...
Your workspace is where everything lives — your projects, courses, sources, students, and team members.
...
Your workspace runs on a plan. The plan decides what features you can use and how much you can create.
...
**Upgrades** happen right away. **Downgrades** take effect at the end of your current billing period.

## Owner and Admin

Everyone who uses your workspace has a role. The role decides what they can do.
...
### Teacher / Staff
Teachers create content and grade work. They can:
- Create and edit projects
- Create and manage courses
- Grade student work
- Set up AI tutors

Teachers **cannot** invite members or change workspace settings.

### Quick Reference

| What They Can Do | Owner | Admin | Teacher | Student |
|-----------------|-------|-------|---------|---------|
...
5. Pick their role (Admin, Teacher, or Student)
...
Students are people who take your courses, complete worksheets, and take quizzes. They have the **Student** role.
...
| Behind pace | They're not keeping up with the rest of the class |

### Grading Student Work

When students submit work through a course:
...
6. Save and the student can see their grade

### Subscriptions (Coming Soon)

Soon, you'll be able to charge students for access to your courses through paid subscriptions.

## Creating a Workspace

1. Click your profile picture in the top-right corner
2. Click **Create Workspace**
3. Give it a name (for example: "Mrs. Smith's 5th Grade" or "AP Biology")
