...
An AI tutor is like a teaching assistant that's always available. Students click the chat button during a lesson and ask for help. The tutor gives hints and asks questions instead of just telling them the answer.
...
3. Fill in these fields:
   ...
   - **Never Reveal Answers** - turn this on to stop the tutor from ever giving away answers
...
|-----------|--------------|
| Students are learning something new | Guided |
| Students are practicing skills | Socratic or Hints |
...
This tutor will be available in every lesson of the course.
