...
Checkfu quizzes adjust to each student. If a student keeps getting answers right, the questions get harder. If they're struggling, the questions get easier. This way, you can see what each student actually knows instead of just whether they passed or failed.
...
| 2 | Below grade level. Slightly harder than basic. |
| 3 | On grade level. This is where most students should be. |
| 4 | Challenging. Requires deeper thinking. |
| 5 | Advanced. Extension or above grade level. |

## When the Quiz Ends

A quiz stops when one of these things happens:

| What Happens | What It Means |
|-------------|--------------|
| **Mastery** | The student got several hard questions right in a row. They've shown they understand the material. |
| **Target Reached** | The student answered the target number of questions. |
| **Max Questions** | The student hit the maximum number of questions allowed. |
...
You control how the quiz works for your students:
...
| **Allow Early Exit** | Let strong students finish early | Yes |
| **Extended Practice** | Give struggling students more questions | Yes |
...
This helps you know exactly what to review or reteach.
