...
A final exam is a test at the end of your course. It pulls questions from all your lessons and adjusts difficulty the same way lesson quizzes do — harder questions when a student answers correctly, easier ones when they don't.
...
4. The test adapts in real time, just like the lesson quizzes
...
What happens: AI takes the quiz questions from your lessons and creates new versions of each one (the number you picked). The new questions keep the same difficulty levels and concept tags, so every student gets a different set.

If you already have a question bank and want to rebuild it, the button says **Regenerate Question Bank** instead.

<Warning>
Your lessons need quiz questions first. If your lessons don't have quizzes, the question bank won't have anything to pull from.
</Warning>
...
The final exam works the same way as lesson quizzes:
...
If AI graded a free response question wrong (or you disagree with the score), you can:
...
<AccordionGroup>
  ...
  <Accordion title="Review the question bank">
    After AI generates the question bank, look through some of the questions to make sure they're accurate.
  </Accordion>
  ...
  <Accordion title="Consider a time limit for test security">
    A time limit keeps students from looking up every answer. A good rule of thumb is about 1-2 minutes per question.
  </Accordion>
</AccordionGroup>
