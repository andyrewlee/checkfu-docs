...
## AI Tools in the Toolbar

The toolbar has two types of AI actions: **Edit** and **Create**.

### Edit

Edit changes something that's already on the page. There are two ways to do it:

**Paint and regenerate** — Use the paint tool to brush over the part you want to change. AI fills in that area with new content while keeping everything else the same. Good for replacing a single problem, swapping out an image, or fixing a section you don't like.

**Recreate with a prompt** — Write a prompt describing what you want changed and send the current page as a reference image. AI rebuilds the page based on your instructions while keeping the overall look. Good for bigger changes like "make all the problems about fractions instead of decimals."

### Create

Create adds new frames to your project. Instead of changing what's already there, it generates something new:

- **Answer Key** — AI reads your worksheet and generates answer pages (see [Answer Keys](#answer-keys) below)
- **Variation** — AI creates a new version of your worksheet with different questions (see [Variations](#variations) below)
