...
The toolbar also has AI editing tools. You can paint over part of a slide to regenerate just that area, or send the whole slide as a reference with a prompt to recreate it. See [AI Tools in the Toolbar](/projects/worksheets#ai-tools-in-the-toolbar) for details.
